...
- Memory checking must pass for covered safe-wrapper paths, either through a CI sanitizer/Valgrind-style gate or an explicitly recorded platform memory checker.
